...
class Requirement(packaging.requirements.Requirement):
    ...
    marker: packaging.markers.Marker | None
    @staticmethod
...
class EntryPoint:
    ...
    @classmethod
    def parse_group(
        cls, group: str, lines: str | Sequence[str], dist: Distribution | None = ...
    ) -> dict[str, EntryPoint]: ...
    @classmethod
    def parse_map(
        cls,
        data: dict[str, str | Sequence[str]] | str | Sequence[str],
        dist: Distribution | None = ...,
    ) -> dict[str, EntryPoint]: ...
    def load(
        self,
...
class Distribution(IResourceProvider, IMetadataProvider):
    ...
    @property
    def parsed_version(self) -> packaging.version.Version: ...
    py_version: str
    platform: str | None
    precedence: int
    def __init__(
    ...
    @classmethod
    def from_filename(
        cls, filename: str, metadata: _MetadataType = ..., **kw: str | None | int
    ) -> Distribution: ...
